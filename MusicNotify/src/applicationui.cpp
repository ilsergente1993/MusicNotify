...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("MusicNotify_%1").arg(locale_string);
...
void ApplicationUI::resendNotification()
{
    ...
    request.setTarget("com.example.MusicNotifyService");
    request.setAction("com.example.MusicNotifyService.RESET");
    m_invokeManager->invoke(request);
    qDebug()<<"Invio notifica (UI C++)";
